 ...
 * @author Raghuram
 */
public class Rid70 extends Transport implements Runnable {
    
    private static final int REQUEST_ID = 70;
    ...
    public void run() {
        System.out.println("sending RID 70");
        this.transportData = super.sendAndReceive(transportData);
        System.out.println("Receivced RID 70");
        //ChatMaster.getP2pMessage().receiveRid70(this.transportData);
    }
