 ...
 * @author Raghuram
 */
public class Rid22 extends Transport implements Runnable {
    
    private static final int REQUEST_ID = 22;
    ...
    public void run() {
        System.out.println("sending RID 22");
        this.transportData = super.sendAndReceive(transportData);
        System.out.println("Receivced RID 22");
        ChatMaster.getLogin().receiveRid22(this.transportData);
    }
