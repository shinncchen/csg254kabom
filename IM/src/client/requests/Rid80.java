 ...
 * @author Raghuram
 */
public class Rid80 extends Transport implements Runnable {
    
    private static final int REQUEST_ID = 80;
    ...
    public void run() {
        System.out.println("sending RID 80");
        this.transportData = super.sendAndReceive(transportData);
        System.out.println("Receivced RID 80");
        //ChatMaster.getLogout().receiveRid80(this.transportData);
    }
