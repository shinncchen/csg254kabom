 ...
 * @author Raghuram
 */
public class Rid60 extends Transport implements Runnable {
    
    private static final int REQUEST_ID = 60;
    ...
    public void run() {
        System.out.println("sending RID 60");
        this.transportData = super.sendAndReceive(transportData);
        System.out.println("Receivced RID 60");
        //ChatMaster.getP2pAuth().receiveRid60(this.transportData);
    }
