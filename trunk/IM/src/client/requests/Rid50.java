 ...
 * @author Raghuram
 */
public class Rid50 extends Transport implements Runnable {
    
    private static final int REQUEST_ID = 50;
    ...
    public void run() {
        System.out.println("sending RID 50");
        this.transportData = super.sendAndReceive(transportData);
        System.out.println("Receivced RID 50");
        //ChatMaster.getPermit().receiveRid50(this.transportData);
    }
